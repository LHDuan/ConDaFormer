...
class DotProdWithIdxAllTriPlane(Function):
    ...
    def backward(ctx, grad_output):
        ...
        sptr_cuda.dot_prod_with_idx_tri_plane_backward_cuda(N, M, h, hdim, n_max, L, grad_output, q, index_q_offsets, k, index_k_offsets, index_k, table_q, table_k, rel_idx, m_offsets, grad_q, grad_k, grad_table_q, grad_table_k)
...
class AttentionStep2WithRelPosValueTriPlane(Function):
    ...
    def backward(ctx, grad_output):
        ...
        sptr_cuda.attention_step2_with_rel_pos_value_tri_plane_backward_cuda(N, M, h, hdim, L, n_max, grad_output, index0, index0_offsets, index1, index1_offsets, attn, v, table, rel_idx, m_offsets, grad_attn, grad_v, grad_table)
