...
PYBIND11_MODULE(TORCH_EXTENSION_NAME, m) {
    ...
    m.def("dot_prod_with_idx_all_tri_plane_forward_cuda", &dot_prod_with_idx_all_tri_plane_forward_cuda, "dot_prod_with_idx_all_tri_plane_forward_cuda");
    m.def("dot_prod_with_idx_tri_plane_backward_cuda", &dot_prod_with_idx_tri_plane_backward_cuda, "dot_prod_with_idx_tri_plane_backward_cuda");
    m.def("attention_step1_tri_plane_backward_cuda", &attention_step1_tri_plane_backward_cuda, "attention_step1_tri_plane_backward_cuda");
    m.def("attention_step2_with_rel_pos_value_tri_plane_forward_cuda", &attention_step2_with_rel_pos_value_tri_plane_forward_cuda, "attention_step2_with_rel_pos_value_tri_plane_forward_cuda");
    m.def("attention_step2_with_rel_pos_value_tri_plane_backward_cuda", &attention_step2_with_rel_pos_value_tri_plane_backward_cuda, "attention_step2_with_rel_pos_value_tri_plane_backward_cuda");
}
